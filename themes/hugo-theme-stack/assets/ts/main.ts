...
let Stack = {
  init: () => {
     ...
     */
    document
      .querySelectorAll(".color-tag")
      .forEach(async (tag: HTMLLinkElement) => {
    ...
    const articleSubtitle = document.querySelectorAll(
      ".article-subtitle"
    ) as NodeListOf<HTMLElement>;
    articleSubtitle.forEach(
      (subtitle) => (subtitle.innerHTML = subtitle.innerText)
    );
  },
};
